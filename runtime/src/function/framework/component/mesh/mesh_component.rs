...
use crate::{
    function::{
        framework::{
            object::object_id_allocator::GObjectID, resource::component::mesh::MeshComponentRes,
        },
        render::render_object::{GameObjectLazyMeshDesc, GameObjectMeshDesc, GameObjectPartDesc},
    },
