...
impl DebugDrawManager {
    pub fn create(info: &DebugDrawManagerCreateInfo) -> Result<Self> {
        ...
        let m_debug_draw_pipelines = [
            ...
            DebugDrawPipeline::create(DebugDrawPipelineType::PointNoDepthTest, info.rhi, set_layout)?,
            DebugDrawPipeline::create(DebugDrawPipelineType::LineNoDepthTest, info.rhi, set_layout)?,
            DebugDrawPipeline::create(DebugDrawPipelineType::TriangleNoDepthTest, info.rhi, set_layout)?,
        ];
        Ok(Self { 
            m_mutex: Mutex::new(()),
            m_rhi: m_rhi,
