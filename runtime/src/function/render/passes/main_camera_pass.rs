...
impl MainCameraPass {
    ...
    fn setup_render_pass(&mut self, rhi: &VulkanRHI) -> Result<()> {
        ...
        *swapchain_image_attachment = vk::AttachmentDescription::builder()
        ...
        let mut subpasses = [vk::SubpassDescription::default(); 3];
