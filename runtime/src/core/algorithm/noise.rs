...
fn noise3(x: f32, y: f32, z: f32) -> f32 {
    ...
    let nxy0 = grad3(
        PERM[ix0 as usize + PERM[iy0 as usize + PERM[iz0 as usize] as usize] as usize] as u32,
        fx0,
        fy0,
        fz0,
    );
    let nxy1 = grad3(
        PERM[ix0 as usize + PERM[iy0 as usize + PERM[iz1 as usize] as usize] as usize] as u32,
        fx0,
        fy0,
        fz1,
    );
    ...
    let nxy0 = grad3(
        PERM[ix0 as usize + PERM[iy1 as usize + PERM[iz0 as usize] as usize] as usize] as u32,
        fx0,
        fy1,
        fz0,
    );
    let nxy1 = grad3(
        PERM[ix0 as usize + PERM[iy1 as usize + PERM[iz1 as usize] as usize] as usize] as u32,
        fx0,
        fy1,
        fz1,
    );
    ...
    let nxy0 = grad3(
        PERM[ix1 as usize + PERM[iy0 as usize + PERM[iz0 as usize] as usize] as usize] as u32,
        fx1,
        fy0,
        fz0,
    );
    let nxy1 = grad3(
        PERM[ix1 as usize + PERM[iy0 as usize + PERM[iz1 as usize] as usize] as usize] as u32,
        fx1,
        fy0,
        fz1,
    );
    ...
    let nxy0 = grad3(
        PERM[ix1 as usize + PERM[iy1 as usize + PERM[iz0 as usize] as usize] as usize] as u32,
        fx1,
        fy1,
        fz0,
    );
    let nxy1 = grad3(
        PERM[ix1 as usize + PERM[iy1 as usize + PERM[iz1 as usize] as usize] as usize] as u32,
        fx1,
        fy1,
        fz1,
    );
