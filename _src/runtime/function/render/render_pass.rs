...
pub struct RenderPass{
    ...
    m_render_resource: Weak<RefCell<RenderResource>>,

    m_global_render_resource: Weak<RefCell<GlobalRenderResource>>,
...
pub trait RenderPassTrait : RenderPassBase{
    ...
    fn initialize(&mut self, init_info: RenderPassInitInfo){
        ...
        render_pass.m_global_render_resource = Rc::downgrade(&render_resource.borrow().m_global_render_resource);
    }
