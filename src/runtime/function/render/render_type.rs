...
pub const RHI_SUBPASS_EXTERNAL: u32 = 0xFFFFFFFF;
...
pub struct RenderPipelineType(u8);
impl RenderPipelineType {
    pub const FORWARD_PIPELINE: Self = Self(0);
    pub const DEFERRED_PIPELINE: Self = Self(1);
    pub const PIPELINE_TYPE_COUNT: Self = Self(2);
}
